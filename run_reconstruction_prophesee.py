...
import argparse
import pandas as pd
from utils.event_readers import FixedSizeEventReader, FixedDurationEventReader, PropheseeFixedDurationEventReader
...
if __name__ == "__main__":
    ...
    if args.fixed_duration:
        event_window_iterator = PropheseeFixedDurationEventReader(path_to_events,
